...
def generate_launch_description():
    ...
    path_pkg_dir = get_package_share_directory('local_path')
    pkg_share_dir = get_package_share_directory('path_pursuit')
    ...
    local_path_node = Node(
        ...
        parameters=[os.path.join(path_pkg_dir,'params','params.yaml')],
        # prefix to launch in a new terminal
        # prefix="xterm -e"
    )

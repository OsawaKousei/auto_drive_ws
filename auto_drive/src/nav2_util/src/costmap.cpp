...
Costmap::Costmap(rclcpp::Node *node, bool trinary_costmap,
                 bool track_unknown_space, int lethal_threshold,
                 int unknown_cost_value)
    : node_(node), trinary_costmap_(trinary_costmap),
...
bool Costmap::is_free(const unsigned int x_coordinate,

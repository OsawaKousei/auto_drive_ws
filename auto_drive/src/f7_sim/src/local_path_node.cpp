...
public:
  PurePNode() : Node("pure_p_node") {
    ...
    //     pos_data.z = atan2(2.0 * (msg.transform.rotation.x *
    //     msg.transform.rotation.y + msg.transform.rotation.z *
    //     msg.transform.rotation.w),
    //                 1.0 - 2.0 * (msg.transform.rotation.y *
    //                 msg.transform.rotation.y + msg.transform.rotation.z *
    ...
    // odom_sub = this->create_subscription<TFMessage>("/odom/tf", qos,
    // odom_callback);
    fixed_pos_sub =
        this->create_subscription<Point>("fixed_pos", qos, fixed_pos_callback);

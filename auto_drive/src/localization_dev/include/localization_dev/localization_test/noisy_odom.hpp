...
namespace localization_dev
{
  ...
  /// @details This class adds noise to the odometry and publishes the noisy odometry.
  /// The noisy odometry is published as an Odometry message.
  /// The real odometry is received from the /odom topic.
  /// The noise is added to the x, y, and theta values of the odometry.

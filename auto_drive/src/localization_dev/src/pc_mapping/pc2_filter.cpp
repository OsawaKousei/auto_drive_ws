...
: rclcpp::Node("pc2_filter", options)
{
    raw_pc2_sub = this->create_subscription<sensor_msgs::msg::PointCloud2>(
        "combined_pc2", 1, [this](const sensor_msgs::msg::PointCloud2::SharedPtr msg) { topic_callback(msg); });
...
void Pc2Filter::topic_callback(const sensor_msgs::msg::PointCloud2::SharedPtr msg){
    mutex_.lock();
